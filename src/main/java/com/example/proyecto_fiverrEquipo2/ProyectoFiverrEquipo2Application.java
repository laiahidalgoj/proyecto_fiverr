...
public class ProyectoFiverrEquipo2Application {
	...
	public static void main(String[] args) {
		...
		Vendedor vendedor1 = new Vendedor(null, "laia_hidalgo", "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris.", Nivel.Nivel1, "laia@laia.es", Empresa.Autonomo, Pais.España);
		Vendedor vendedor2 = new Vendedor(null, "maria_perez", "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris.", Nivel.Nivel1, "maria@maria.es", Empresa.Autonomo, Pais.EEUU);
		Vendedor vendedor3 = new Vendedor(null, "luis_callado", "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris.", Nivel.Nivel2, "luis@luis.es", Empresa.Autonomo, Pais.Italia);
		Vendedor vendedor4 = new Vendedor(null, "toni_rubio", "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris.", Nivel.Nivel2, "toni@toni.es", Empresa.Autonomo, Pais.España);
		Vendedor vendedor5 = new Vendedor(null, "marcos_ruiz", "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris.", Nivel.MejorCalificado, "marcos@marcos.es", Empresa.Privada, Pais.Francia);
		Vendedor vendedor6 = new Vendedor(null, "lucia_ortiz", "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris.", Nivel.Nivel1, "lucia@lucia.es", Empresa.Privada, Pais.Francia);
		Vendedor vendedor7 = new Vendedor(null, "marta_colado", "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris." , Nivel.MejorCalificado, "marta@marta.es", Empresa.Autonomo, Pais.España);
		Vendedor vendedor8 = new Vendedor(null, "ernesto_garcia", "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris.", Nivel.Nivel1, "ernesto@ernesto.es", Empresa.Autonomo, Pais.España);
