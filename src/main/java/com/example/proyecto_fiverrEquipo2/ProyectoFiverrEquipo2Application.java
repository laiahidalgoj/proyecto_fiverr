...
public class ProyectoFiverrEquipo2Application {
	...
	public static void main(String[] args) {
		...
		Vendedor vendedor1 = new Vendedor(null, "laia_hidalgo", "Diseño tu web a medida, además me encargo del marketing digital para una mayor visibilidad", Nivel.Nivel1, "laia@laia.es", Empresa.Autonomo, Pais.España);
		Vendedor vendedor2 = new Vendedor(null, "maria_perez", "Diseño animaciones en 3D y desarrollo la web de tu negocio", Nivel.Nivel1, "maria@maria.es", Empresa.Autonomo, Pais.EEUU);
		Vendedor vendedor3 = new Vendedor(null, "luis_callado", "Diseño tu web creativa y única optimizada para el SEO", Nivel.Nivel2, "luis@luis.es", Empresa.Autonomo, Pais.Italia);
		...
		Vendedor vendedor5 = new Vendedor(null, "marcos_ruiz", "Me encargo del social media y el diseño UX/UI", Nivel.MejorCalificado, "marcos@marcos.es", Empresa.Privada, Pais.Francia);
		...
		Vendedor vendedor8 = new Vendedor(null, "ernesto_garcia", "Diseñamos tu ecommerce a tu medida", Nivel.MejorCalificado, "marta@marta.es", Empresa.Autonomo, Pais.España);
		Vendedor vendedor9 = new Vendedor(null, "veronica_tamiz", "Diseñamos tu ecommerce a tu medida", Nivel.MejorCalificado, "marta@marta.es", Empresa.Autonomo, Pais.España);
