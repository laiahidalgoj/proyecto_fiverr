...
public class Paquetes {
    ...
    public Paquetes(Long id, String tipoPaquete, Integer numeroPaginas, Boolean actualizaciones, Integer numeroRevisiones, Boolean archivosFuente, Integer tiempoEntrega, Double precio) {
        this.id = id;
